...
public class PlatformsFragment extends Fragment {
     ...
     * @return A new instance of fragment PlatformsFragment.
     */
    ...
    public void onViewCreated(@NonNull View view, @Nullable Bundle savedInstanceState) {
        Button confermaPlatformsButton = view.findViewById(R.id.confermaPiattaformeButton);

        confermaPlatformsButton.setOnClickListener(v -> {
            Navigation.findNavController(v).navigate(R.id.action_platformsFragment_to_typeFragment);
        });
    }
}